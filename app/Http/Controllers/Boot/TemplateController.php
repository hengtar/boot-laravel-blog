...
class TemplateController extends CommonController
{
    ...
    public function sort(Request $request)
    {
        try {
            foreach ($request->sort as $key => $value) {
                ...
                Template::where('id', $key)->update(['sort' => $value]);
            }
    ...
    {
        return view('boot.template.create');
    }
    ...
    public function store(StoreRole $request)
    {
        ...
        //create template key => value
        $result = Template::create($param);

        //save template
        if ($result->save()) {
            return response()->json(['success' => true, 'url' => route('template-index')]);
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('boot.template.edit', [
    ...
    public function update(StoreRole $request)
    {
        ...
        //create template key => value
        $article = Template::find($param['id']);
...
//
//
//        return view('boot.template.auth',[
//            'permissions' => list_to_tree($permissions),
//            'rolePermissions' => $rolePermissions,
//            'roleInfo' => Template::find($id)
//        ]);
//    }
//
