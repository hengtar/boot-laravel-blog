            ...
            <div class="ui segment">
                <div class="content extra-padding">
                    <div class="ui header text-center text gery" style="margin:10px 0 40px">
                        <i class="glyphicon glyphicon-pencil"></i> 添加分类
                    </div>
                    <form method="post" action="{{ route('advertCategory-store') }}" accept-charset="UTF-8" class="ui form"
                          style="min-height: 50px;" id="insert">
                        {{ csrf_field() }}

                        <div class="field">
                            <input class="form-control" type="text" name="category" id="title-field" placeholder="名称">
                        </div>
                        ...
                        <div class="field">
                            ...
                            <select class="form-control ui search multiple selection tags dropdown  advertCategory"
                                ...
                                @foreach($advertCategory as $cate)
