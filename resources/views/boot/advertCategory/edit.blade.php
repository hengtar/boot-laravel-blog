        ...
        <div class="twelve wide column">
            <div class="ui segment">
                <div class="content extra-padding">
                    ...
                    <form method="post" action="{{ route('advertCategory-update') }}" accept-charset="UTF-8" class="ui form"
                          style="min-height: 50px;" id="insert">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $advertCategory -> id }}">

                        <div class="field">
                            <input class="form-control" type="text" name="category" id="title-field" placeholder="名称" value="{{ $advertCategory -> category }}">
                        </div>

                        <div class="field">
                            <input class="form-control" type="text" name="keywords" id="title-field" placeholder="关键词" value="{{ $advertCategory -> keywords }}">
                        </div>

                        <div class="field">
                            <textarea class="form-control" type="text" name="summary" id="title-field" placeholder="描述"> {{ $advertCategory -> summary }}</textarea>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <select class="form-control ui search multiple selection tags dropdown  advertCategory"
                                    name="p_id">
                                <option value="0">默认顶级</option>
                                @foreach($advertCategory_list as $cate)
                                    <option value="{{ $cate -> id }}"  {{ $cate -> id == $advertCategory -> p_id ? 'selected' :''  }}>{{ $cate -> lefthtml }}{{ $cate -> category }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="field">
                            <div class="input-group col-sm-12">
                                <input type="hidden" id="data_photo" name="photo" value="{{ $advertCategory -> photo }}">


                                <div id="imgPicker" class="col-sm-2" >选择图片</div>
                                <img id="img_data" class="col-sm-2" style="margin-top: -5px;" src="{{ $advertCategory -> photo }}"/>
                        ...
                        <div class="field">
                            <input class="form-control" type="text" name="sort" id="title-field"
                                   placeholder="排序 (数越大越靠前 1 - 100 默认：50)" value="{{ $advertCategory -> sort }}">
                        </div>
                        <br/>
                        <div class="ui segment private-checkbox">
                            <div class="field">
                                <div class="ui toggle checkbox">
                                    <input type="checkbox" class="js-switch" name="status" {{ $advertCategory -> status ? "checked" :'' }} style="margin-left: -2px;"/>
                        ...
                        <div class="ui message">
                            ...
                            &nbsp;&nbsp;or&nbsp;&nbsp;
                            <a href="{{ route('advertCategory-index') }}" class="ui button"  name="subject" value="draft">
