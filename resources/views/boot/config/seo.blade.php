                    ...
                    <form method="post" action="{{ route('config-store') }}" accept-charset="UTF-8" class="ui form"
                        ...
                        <div class="field">
                            <div class="input-group col-sm-12">
                                <input type="hidden" id="data_photo" name="logo" value="{{ $config -> logo }}">

                                <div id="imgPicker" class="col-sm-2" >上传LOGO</div>
                                <img id="img_data" class="col-sm-2" style="margin-top: -5px;" src="{{ $config -> logo ?? asset('/static/boot/img/no_img.jpg') }}"/>
