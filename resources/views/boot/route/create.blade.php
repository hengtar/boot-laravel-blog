        ...
        <div class="twelve wide column">
            <div class="ui segment">
                <div class="content extra-padding">
                    ...
                    <form method="post" action="{{ route('route-store') }}" accept-charset="UTF-8" class="ui form"
                          style="min-height: 50px;" id="insert">
                        {{ csrf_field() }}

                        <div class="field">
                            <input class="form-control" type="text" name="id"  placeholder="菜单ID">
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <select class="form-control ui search multiple selection tags dropdown  category"
                                ...
                                @foreach($routes as $route)
                                    <option  value="{{ $route -> id }}" >{{ $route -> lefthtml }}{{ $route -> title }}</option>
                                @endforeach
                            </select>
                        ...
                        <br>
                        <div class="field">
                            <input class="form-control" type="text" name="route"  placeholder="菜单路由别名(自动生成 默认：不填写)">
                        </div>
