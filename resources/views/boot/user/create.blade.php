            ...
            <div class="ui segment">
                <div class="content extra-padding">
                    <div class="ui header text-center text gery" style="margin:10px 0 40px">
                        <i class="glyphicon glyphicon-pencil"></i> 添加用户
                    </div>
                    <form method="post" action="{{ route('user-store') }}" accept-charset="UTF-8" class="ui form"
                          style="min-height: 50px;" id="insert">
                        {{ csrf_field() }}

                        <div class="field">
                            <input class="form-control" type="text" name="name" id="title-field" placeholder="用户名">
                        </div>
                        <div class="field">
                        <input class="form-control" type="text" name="email" id="email-field" placeholder="邮箱">
                        </div>
